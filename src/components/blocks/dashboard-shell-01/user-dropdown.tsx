  ...
  return (
    <div className="flex items-center justify-center">
      <DropdownMenu defaultOpen={defaultOpen}>
        ...
        <DropdownMenuContent
          align={align}
          className="data-open:slide-in-from-bottom-20! data-closed:slide-out-to-bottom-20 data-open:fade-in-0 data-closed:fade-out-0 data-closed:zoom-out-100 w-3xs rounded-2xl duration-400"
        >
          {/* User Info */}
          <DropdownMenuGroup>
